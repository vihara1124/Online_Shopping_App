...
public class DisplayItem extends AppCompatActivity {
    ...
    public void onBackPressed(){
        ...
        if(ca.equals("Shoes")){
            ...
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Frocks")){
            Intent intent=new Intent(DisplayItem.this, Frocks.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("LatestDeals")){
            Intent intent=new Intent(DisplayItem.this, LatestDeals.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Watches")){
            Intent intent=new Intent(DisplayItem.this, Watches.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Bags")){
            Intent intent=new Intent(DisplayItem.this, Bags.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
